...
CASES: list[tuple[str, str, str]] = [
    ...
    # ── Terraform v1.14.x: side-effect-free subcommands ──
    ("terraform version",                                 "allow", "tf version"),
    ("terraform version -json",                           "allow", "tf version -json"),
    ("terraform -version",                                "allow", "tf -version short form"),
    ("terraform -help",                                   "allow", "tf -help"),
    ("terraform -help plan",                              "allow", "tf -help plan"),
    ("terraform fmt -check",                              "allow", "tf fmt -check bare"),
    ("terraform fmt -check -recursive",                   "allow", "tf fmt -check -recursive"),
    ("terraform fmt -check -diff -recursive .",           "allow", "tf fmt -check with flags"),
    ("terraform validate",                                "allow", "tf validate bare"),
    ("terraform validate -json",                          "allow", "tf validate -json"),
    ("terraform show",                                    "allow", "tf show bare"),
    ("terraform show -json",                              "allow", "tf show -json"),
    ("terraform show tfplan",                             "allow", "tf show tfplan file"),
    ("terraform output",                                  "allow", "tf output bare"),
    ("terraform output -json",                            "allow", "tf output -json"),
    ("terraform output -raw my_output",                   "allow", "tf output -raw"),
    ("terraform graph",                                   "allow", "tf graph"),
    ("terraform graph -type=plan",                        "allow", "tf graph -type"),
    ("terraform providers",                               "allow", "tf providers bare"),
    ("terraform providers schema",                        "allow", "tf providers schema"),
    ("terraform providers schema -json",                  "allow", "tf providers schema -json"),
    ("terraform state list",                              "allow", "tf state list bare"),
    ("terraform state list aws_instance.*",               "allow", "tf state list filter"),
    ("terraform state show aws_instance.foo",             "allow", "tf state show"),
    ("terraform state pull",                              "allow", "tf state pull"),
    ("terraform workspace list",                          "allow", "tf workspace list"),
    ("terraform workspace show",                          "allow", "tf workspace show"),
    ("terraform metadata functions",                      "allow", "tf metadata functions"),
    ("terraform metadata functions -json",                "allow", "tf metadata functions -json"),
    # -chdir variants
    ("terraform -chdir=./infra validate",                 "allow", "tf -chdir validate"),
    ("terraform -chdir=./infra fmt -check -recursive",    "allow", "tf -chdir fmt -check"),
    ("terraform -chdir=/path/to/env state list",          "allow", "tf -chdir state list"),
    ("terraform -chdir=./infra providers schema -json",   "allow", "tf -chdir providers schema"),
    # Mutating / interactive / auth verbs fall through to *: ask
    ("terraform init",                                    "ask",   "tf init mutates (downloads providers)"),
    ("terraform init -backend-config=x",                  "ask",   "tf init with flags"),
    ("terraform plan",                                    "ask",   "tf plan refreshes state (mutates backend)"),
    ("terraform apply",                                   "ask",   "tf apply"),
    ("terraform apply -auto-approve",                     "ask",   "tf apply auto-approve"),
    ("terraform destroy",                                 "ask",   "tf destroy"),
    ("terraform refresh",                                 "ask",   "tf refresh"),
    ("terraform get",                                     "allow", "tf get — writes only to .terraform/modules cache"),
    ("terraform get -update",                             "allow", "tf get -update"),
    ("terraform -chdir=./infra get",                      "allow", "tf -chdir get"),
    ("terraform import aws_instance.foo i-123",           "ask",   "tf import"),
    ("terraform taint aws_instance.foo",                  "ask",   "tf taint"),
    ("terraform untaint aws_instance.foo",                "ask",   "tf untaint"),
    ("terraform force-unlock LOCK_ID",                    "ask",   "tf force-unlock"),
    ("terraform login",                                   "ask",   "tf login (auth)"),
    ("terraform logout",                                  "ask",   "tf logout (auth)"),
    ("terraform console",                                 "ask",   "tf console (interactive REPL)"),
    ("terraform test",                                    "ask",   "tf test (may provision real infra)"),
    ("terraform fmt",                                     "ask",   "tf fmt rewrites files without -check"),
    ("terraform fmt -recursive",                          "ask",   "tf fmt -recursive without -check"),
    ("terraform fmt -diff",                               "ask",   "tf fmt -diff without -check"),
    ("terraform state mv a b",                            "ask",   "tf state mv mutates"),
    ("terraform state rm aws_instance.foo",               "ask",   "tf state rm"),
    ("terraform state push terraform.tfstate",            "ask",   "tf state push"),
    ("terraform state replace-provider old new",          "ask",   "tf state replace-provider"),
    ("terraform workspace new prod",                      "ask",   "tf workspace new"),
    ("terraform workspace select prod",                   "ask",   "tf workspace select writes current"),
    ("terraform workspace delete staging",                "ask",   "tf workspace delete"),
    ("terraform providers lock -platform=linux_amd64",    "ask",   "tf providers lock mutates"),
    ("terraform providers mirror ./mirror",               "ask",   "tf providers mirror downloads"),
