...
> **Superseded by `docs/design/theming.md`** (2026-04-17).
>
> The fallback chain, per-tool tier assignment, licensing handling, migration
> plan, and acceptance criteria have been replaced by the theming design at
> `macos-dev/docs/design/theming.md`. The new chain no longer falls through
> unmodified Dracula Classic — Pro-from-Classic substitution (Tier 2) and
> custom Pro-palette reconstruction (Tier 3) are the only fallbacks.
>
> Consult `docs/design/theming.md` for the authoritative palette, tier
> assignments, and wave-by-wave migration ordering. This section is retained
> solely as a historical heading anchor for existing cross-references.
